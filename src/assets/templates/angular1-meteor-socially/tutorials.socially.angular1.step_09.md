...
<diffbox tutorial="angular1-meteor-socially" step="9.2"></diffbox>

Let's also move collection to separate file:

<diffbox tutorial="angular1-meteor-socially" step="9.3"></diffbox>

Replace `parties.js` with `index.js`:

<diffbox tutorial="angular1-meteor-socially" step="9.4"></diffbox>
...
<diffbox tutorial="angular1-meteor-socially" step="9.6"></diffbox>
...
<diffbox tutorial="angular1-meteor-socially" step="9.11"></diffbox>
...
<diffbox tutorial="angular1-meteor-socially" step="9.12"></diffbox>
...
<diffbox tutorial="angular1-meteor-socially" step="9.13"></diffbox>
...
<diffbox tutorial="angular1-meteor-socially" step="9.14"></diffbox>

# Testing

<diffbox tutorial="angular1-meteor-socially" step="9.15"></diffbox>

<diffbox tutorial="angular1-meteor-socially" step="9.16"></diffbox>
