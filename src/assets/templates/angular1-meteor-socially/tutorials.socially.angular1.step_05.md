...
<diffbox tutorial="angular1-meteor-socially" step="5.1"></diffbox>

Then add the ui-router as a dependency to our Socially app in `socially.js`:

<diffbox tutorial="angular1-meteor-socially" step="5.2"></diffbox>
...
<diffbox tutorial="angular1-meteor-socially" step="5.3"></diffbox>

We still need to add uiView directive, Socially is the best place for it:

<diffbox tutorial="angular1-meteor-socially" step="5.4"></diffbox>

Let's define a default route and use html5 mode to make urls look a lot fancier:

<diffbox tutorial="angular1-meteor-socially" step="5.6"></diffbox>

It would be nice to have a navigation. Create one! Let's call our new component `Navigation`:

<diffbox tutorial="angular1-meteor-socially" step="5.7"></diffbox>

<diffbox tutorial="angular1-meteor-socially" step="5.8"></diffbox>

And implement it in `Socially`:

<diffbox tutorial="angular1-meteor-socially" step="5.9"></diffbox>

<diffbox tutorial="angular1-meteor-socially" step="5.10"></diffbox>
...
<diffbox tutorial="angular1-meteor-socially" step="5.5"></diffbox>
...
<diffbox tutorial="angular1-meteor-socially" step="5.11"></diffbox>

Now we can create actual component:

<diffbox tutorial="angular1-meteor-socially" step="5.12"></diffbox>

And also define new route which was mentioned before as `/parties/:partyId`:

<diffbox tutorial="angular1-meteor-socially" step="5.13"></diffbox>

Now let's add a link from each party in the parties list to it's details page:

<diffbox tutorial="angular1-meteor-socially" step="5.14"></diffbox>

<diffbox tutorial="angular1-meteor-socially" step="5.15"></diffbox>
